        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <footer class="bg-white sticky-footer">
                <div class="container my-auto">
                    <div class="text-center my-auto copyright"><span>Copyright © Noroton&nbsp;2024</span></div>
                </div>
            </footer>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="functions/add-staff.php" method="post">
                        ...
                        <div class="mb-3"><label class="form-label" for="Employee"><strong>Employee Name</strong></label><input class="form-control" type="text" placeholder="Employee Name" name="Employee" required=""></div>
                        ...
                        <div class="mb-3"><label class="form-label" for="Address"><strong>Address</strong></label><input class="form-control" type="text" placeholder="Address" name="Address" required=""></div>
                        <div class="mb-3">
                            <label class="form-label" for="Contact"><strong>Mobile Number</strong></label>
                            <input class="form-control" type="tel" placeholder="Mobile Number" name="Contact" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" required>
                            <small>Format: 123-456-7890</small>
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="Salary"><strong>Salary Per Month</strong></label>
                            <input class="form-control" type="number" placeholder="Salary Per Month" name="Salary" step="0.01" min="0" required>
                        </div>

                        <div class="mb-3"><label class="form-label" for="JoinDate"><strong>Join Date</strong></label><input class="form-control" type="date" placeholder="JoinDate" name="JoinDate" required=""></div>
                        <div class="mb-3"><label class="form-label" for="EndDate"><strong>Stop Date</strong></label><input class="form-control" type="date" placeholder="EndDate" name="EndDate" required=""></div>
