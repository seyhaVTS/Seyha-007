            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="functions/add-supply.php" method="post">
                        ...
                        <div class="mb-3"><label class="form-label"><strong>Price</strong></label><input class="form-control" type="number" name="price" placeholder="Price" required="" min="1" value="1"></div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="functions/update-supply.php" method="post">
                        ...
                        <div class="mb-3"><label class="form-label"><strong>Item Name</strong></label><input class="form-control" type="text" name="name" placeholder="Name" required=""></div>
                        <div class="mb-3"><label class="form-label"><strong>Item Unit</strong></label><input class="form-control" type="text" name="unit" placeholder="Unit" required=""></div>
                        <div class="mb-3"><label class="form-label"><strong>Price</strong></label><input class="form-control" type="number" name="price" placeholder="price" required=""></div>
                </div>
                <div class="modal-footer"><button class="btn btn-primary" type="submit">Save</button></div>
                </form>
            </div>
