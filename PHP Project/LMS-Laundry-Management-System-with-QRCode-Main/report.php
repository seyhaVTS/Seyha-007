...
<head>
    ...
    <title>Admin Report - Transaction </title>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Admin Report</h3>
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">Transactions Report</p>
                        </div>

                        <div class="card-body">
                            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                                <label for= $v_fr>Report Date:</label>
                                <input type="date" id="fr_date" name="fr_date">
                                <label for=$v_to>to Date:</label>
                        ...
                        <div class="card-body">
                            <div class="table-responsive table mt-2" id="mytable" role="grid" aria-describedby="dataTable_info">
                                <table class="table table-striped my-0" id="dataTable"> 
                                    ...
                                    <tbody>
                                        <?php
                                            include_once 'functions/views/report.php'
                                        ?>
                                    </tbody>
                                    <footer>
                                    </footer>
